...
func run() error {
	...
	inspectionService := appinspection.NewService(inspectionRepo, hiveVerifier, mediaClient, cfg.InspectionWarningThresholdDays, notifications, subscriptionClient)
